    ...
    <div className="space-y-6">
      ...
      <div className="stats-card">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Attività di {athleteName}</h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">Panoramica completa delle performance registrate</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <div className="bg-blue-50/50 dark:bg-blue-900/30 rounded-xl p-4 text-center">
            <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Totale Attività</div>
            <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{stats.totalActivities}</div>
          </div>
          <div className="bg-emerald-50/50 dark:bg-emerald-900/30 rounded-xl p-4 text-center">
            <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Distanza</div>
            <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{stats.totalDistanceKm}km</div>
          </div>
          <div className="bg-orange-50/50 dark:bg-orange-900/30 rounded-xl p-4 text-center">
            <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Tempo</div>
            <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">{formatDuration(stats.totalDurationSeconds)}</div>
          </div>
          <div className="bg-purple-50/50 dark:bg-purple-900/30 rounded-xl p-4 text-center">
            <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Con GPS</div>
            <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">{stats.activitiesWithGPS}</div>
          </div>
          <div className="bg-red-50/50 dark:bg-red-900/30 rounded-xl p-4 text-center">
            <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">TSS Medio</div>
            <div className="text-2xl font-bold text-red-600 dark:text-red-400">{stats.avgTSS}</div>
          </div>
        </div>
      </div>
